...
export class MovieController {
  ...
  @ApiQuery({
    name: 'page',
    required: false,
    description: 'Indicates the page number where the paging will start.',
  })
  @ApiQuery({
    name: 'limit',
    required: false,
    description: 'Indicate the limit of movies you will get in your request',
  })
  @Get()
  async getAll(
  ...
  @ApiOperation({
    ...
    description:
      'This endpoint allows you to clone a movie along with its platforms and reviews.',
  })
  @Post('/clone/:id')
  async clone(
    @Param('id', MongoIdValidationPipe) id: string,
